    ...
    <Form.Control as="select" custom onChange={this.onChangeTheme.bind(this)}>
      ...
      <option>Theme5</option>
              ...
              <div class="input-block">
                ...
                <input id="name" name="phone"  onChange={this.onChange} type="tel" required/>
              </div>
              <div class="input-block">
              ...
              <div class="input-block">
                ...
                <input id="name" name="bio"  onChange={this.onChange} type="text" required/>
              </div>
              <div class="input-block">
              ...
              <div class="input-block">
                ...
                <input id="name" name="job_title"  onChange={this.onChange} type="text" required/>
              </div>
              <div class="input-block">
              ...
              <div class="input-block">
                ...
                <input id="name" name="skills"  onChange={this.onChange} type="text" required/>
              </div>
              <div class="input-block">
